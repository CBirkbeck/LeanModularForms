...
private theorem seg1F (z : ℂ) (H : ℝ) (hz : z.re < 1/2) :
  ...
  LogDerivFTCFM.ftc_log_pieceFM (by norm_num) (ref1_cd z H).continuous.continuousOn
...
private theorem seg5F (z : ℂ) (H : ℝ) (hz : z.im < H) :
  ...
  LogDerivFTCFM.ftc_log_pieceFM (by norm_num) (ref5_cd z H).continuous.continuousOn
...
private theorem seg4F (z : ℂ) (H : ℝ) (hz : -1/2 < z.re) :
  ...
  have hp := LogDerivFTCFM.ftc_log_pieceFM (by norm_num : (3:ℝ)/5 ≤ 4/5)
...
private theorem arcF_standard {z : ℂ} (hz_norm : 1 < ‖z‖)
  ...
  LogDerivFTCFM.ftc_log_pieceFM (by norm_num) (arcRef_cd z).continuous.continuousOn
