...
private lemma cpv_exists_of_unique_crossing (γ : PiecewiseC1Immersion) (z₀ : ℂ) (t₀ : ℝ)
    (ht₀ : t₀ ∈ Ioo γ.a γ.b)
    (honly : ∀ t ∈ Icc γ.a γ.b, γ.toFun t = z₀ → t = t₀)
    (hγ_meas : Measurable γ.toFun) (hC2 : ContDiffAt ℝ 2 γ.toFun t₀)
    (h_cont_deriv : ∃ a' b', t₀ ∈ Ioo a' b' ∧ Icc a' b' ⊆ Icc γ.a γ.b ∧
...
private lemma cpv_inv_sub_eq_limit (γ : PiecewiseC1Immersion) (z₀ : ℂ) (L : ℂ)
    (hL : Tendsto (fun ε => ∫ t in γ.a..γ.b, if ‖γ.toFun t - z₀‖ > ε
...
theorem exp_pv_eq_exp_neg_crossing_angle (γ : PiecewiseC1Immersion)
    (hclosed : γ.toPiecewiseC1Curve.IsClosed) (z₀ : ℂ) (t₀ : ℝ)
    (ht₀ : t₀ ∈ Ioo γ.a γ.b) (hcross : γ.toFun t₀ = z₀)
    (honly : ∀ t ∈ Icc γ.a γ.b, γ.toFun t = z₀ → t = t₀)
    (hγ_meas : Measurable γ.toFun) (hC2 : ContDiffAt ℝ 2 γ.toFun t₀)
    (h_cont_deriv : ∃ a' b', t₀ ∈ Ioo a' b' ∧ Icc a' b' ⊆ Icc γ.a γ.b ∧
      ContinuousOn (deriv γ.toFun) (Icc a' b')) :
    Complex.exp (cauchyPrincipalValue' (·⁻¹) (fun t => γ.toFun t - z₀) γ.a γ.b 0) =
...
private lemma externalWindingContribution_eq_int_of_cpv_eq (γ : PiecewiseC1Immersion) (z₀ : ℂ)
    (t₀ : ℝ) (ht₀ : t₀ ∈ Ioo γ.a γ.b) (L : ℂ) (n : ℤ)
    (hPV_eq : cauchyPrincipalValue' (·⁻¹) (fun t => γ.toFun t - z₀) γ.a γ.b 0 = L)
...
theorem externalWindingContribution_isInt (γ : PiecewiseC1Immersion)
    (hclosed : γ.toPiecewiseC1Curve.IsClosed) (z₀ : ℂ) (t₀ : ℝ)
    (ht₀ : t₀ ∈ Ioo γ.a γ.b) (hcross : γ.toFun t₀ = z₀)
    (honly : ∀ t ∈ Icc γ.a γ.b, γ.toFun t = z₀ → t = t₀)
    (hγ_meas : Measurable γ.toFun) (hC2 : ContDiffAt ℝ 2 γ.toFun t₀)
...
theorem generalizedWindingNumber_eq_external_sub_angle (γ : PiecewiseC1Immersion) (z₀ : ℂ)
    (t₀ : ℝ) (ht₀ : t₀ ∈ Ioo γ.a γ.b) :
...
theorem generalizedWindingNumber_eq_neg_angleContribution_single (γ : PiecewiseC1Immersion)
    (_hclosed : γ.toPiecewiseC1Curve.IsClosed) (z₀ : ℂ) (t₀ : ℝ)
    (ht₀ : t₀ ∈ Ioo γ.a γ.b) (_hcross : γ.toFun t₀ = z₀)
...
theorem generalizedWindingNumber_eq_neg_corner_contribution (γ : PiecewiseC1Immersion)
    (hclosed : γ.toPiecewiseC1Curve.IsClosed) (z₀ : ℂ) (t₀ : ℝ) (α : ℝ)
    (ht₀ : t₀ ∈ Ioo γ.a γ.b) (hcross : γ.toFun t₀ = z₀)
    (honly : ∀ t ∈ Icc γ.a γ.b, γ.toFun t = z₀ → t = t₀)
    (hangle : angleAtCrossing γ t₀ ht₀ = α)
    (h_external : externalWindingContribution γ z₀ t₀ ht₀ = 0) :
    generalizedWindingNumber' γ.toFun γ.a γ.b z₀ = -(α / (2 * Real.pi)) := by
  rw [generalizedWindingNumber_eq_neg_angleContribution_single
    γ hclosed z₀ t₀ ht₀ hcross honly h_external, hangle]
...
theorem externalWindingContribution_zero_of_windingNumber_eq (γ : PiecewiseC1Immersion)
...
theorem externalWindingContribution_translate (γ : PiecewiseC1Immersion) (c : ℂ) (t₀ : ℝ)
...
theorem windingNumberWithAngles_union (γ : PiecewiseC1Immersion) (z₀ : ℂ) (S T : Finset ℝ)
    (hST : Disjoint S T) (hS_in : ∀ t ∈ S, t ∈ Ioo γ.a γ.b)
  ...
  rotate_right
  use fun x =>
    if hx : x ∈ S then (angleAtCrossing γ x (hS_in x hx) : ℂ) / (2 * Real.pi)
