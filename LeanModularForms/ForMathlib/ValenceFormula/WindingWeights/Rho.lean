...
private lemma cutoff_integral_eq_ftc (H : ℝ) (hH : Real.sqrt 3 / 2 < H)
  ...
  have h_norm_gt_right : ∀ t ∈ Ioo (3 + δ_R) (5 : ℝ), ‖g t‖ > ε := by
    ...
    · calc ε < H - Real.sqrt 3 / 2 := hε_small
        _ ≤ ‖g t‖ := by
              rw [hg_eq]
              exact g_norm_ge_seg4 H hH (le_of_lt ht4) (le_of_lt ht5)
