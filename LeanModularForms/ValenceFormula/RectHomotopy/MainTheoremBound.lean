                    ...
                    HasDerivAt g_left
                      ((1 - s) •
                        ...
                        s •
                          (i_point - rho'))
                      (2 : ℝ) :=
                  (h_arc_left.const_smul
                    (1 - s)).add
                    (h_chord_left.const_smul s)
                have h_slope_left_iio :=
                  (hasDerivAt_iff_tendsto_slope.mp
                    h_combined_left).mono_left
                    (nhdsWithin_mono (2 : ℝ)
                      (fun y
                        (hy : y < _) =>
                        ne_of_lt hy))
                    ...
                    HasDerivAt g_right
                      ((1 - s) •
                        ...
                        s •
                          (rho - i_point))
                      (2 : ℝ) :=
                  (h_arc_right.const_smul
                    (1 - s)).add
                    (h_chord_right.const_smul s)
                have h_slope_right_ioi :=
                  (hasDerivAt_iff_tendsto_slope.mp
                    h_combined_right).mono_left
                    (nhdsWithin_mono (2 : ℝ)
                      (fun y
                        (hy : _ < y) =>
                        ne_of_gt hy))
