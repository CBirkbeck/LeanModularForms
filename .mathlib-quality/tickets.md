...
- Done: A-1, A-1b, A-2, A-2-wrapper, B-1, **B-2/B-5/B-6 fully closed**, B-3, B-4, **D-1 (a/b/c/d)**, **W-0..W-5**, **C-1**, **C-2 ALL Steps**, **higher-order avoidance closed**, **Phase 3.1-3.8** (k-odd transverse), **ExitTime.lean (full two-sided API)**, **HW33ExitTimeWrapper.lean**, **C-3 avoidance**, **C-4 avoidance closed** + auto-discharge, **HW33Bridge.lean**, **HW33Monotonicity.lean**, **HW33Final.lean**, **HW33MultiPole.lean** (multi-pole transverse closure), **CLEANUP-B (Dixon, -35)**, **CLEANUP-C (HigherOrderCancel, -20)**, **CLEANUP-FINAL (partial — HW33Final, -27)**
- Open: k-even sector PV under angle (B) for the curve case (genuinely incomplete — requires C-2 Step C/D homotopy comparison or new direct argument; even the existing line-model lemma `higherOrder_sector_cancel_even_of_flat` only proves factor simplification, not PV vanishing)
